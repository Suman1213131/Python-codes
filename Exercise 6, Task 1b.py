...
markOne= get_float("enter your first mark> ")
weight_of_first_mark = get_float("enter your weight of the first mark> ")
total_markOne = ((markOne/100) * weight_of_first_mark)
 
print(" ") 
 
markTwo= get_float("enter your second mark> ")
weight_of_second_mark = get_float("enter your weight of the second mark> ")
total_markTwo = ((markTwo/100) * weight_of_second_mark)
 
print(" ")
 
markThree= get_float("enter your third mark> ")
weight_of_third_mark = get_float("enter your weight of the third mark> ")
